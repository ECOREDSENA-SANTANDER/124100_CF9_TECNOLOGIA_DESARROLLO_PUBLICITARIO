...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="zoom-in-left")
      ...
      .col-sm-12.col-lg-8
        p.mb-4 Hace unos pocos años la televisión era el medio por excelencia para lograr el posicionamiento efectivo de una marca, pero hoy los medios digitales la han desplazado de tal manera que se les ha relegado a presupuestos muy bajos en las empresas que están llegando a su mercado objetivo a través de espacios digitales en donde está hoy el interés del grueso de los consumidores. Sin embargo, el formato sigue siendo el mismo en muchos casos, nada mejor que el audiovisual para llegar con el mensaje de manera más efectiva y contundente al #[i target] de un producto o servicio.
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")(data-aos="zoom-in-left")
      ...
      .row(titulo="Problema solución")
        .col-sm-12.col-lg-12
            p.mb-0.pl-cus Se presenta a una marca solucionando una situación difícil y particular del mercado objetivo, por lo general expone una escena cotidiana en la que el consumidor resuelve un problema con el producto o servicio que se está anunciando. Este formato es muy dado para productos del hogar, insecticidas o servicios especializados como seguros. En este formato la redacción, hace énfasis en diálogos y comentarios de la efectividad de la marca anunciada.
