  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
      ...
      .row(titulo="Problema solución")
        .col-sm-12.col-lg-12
            p.mb-0.pl-cus Se muestra a una marca solucionando una situación difícil y particular del mercado objetivo, por lo general expone una escena cotidiana en la que el consumidor resuelve un problema con el producto o servicio que se está anunciando. Este formato es muy dado para productos del hogar, insecticidas o servicios especializados como seguros. En este formato la redacción hace énfasis en diálogos y comentario de la efectividad de la marca anunciada.
